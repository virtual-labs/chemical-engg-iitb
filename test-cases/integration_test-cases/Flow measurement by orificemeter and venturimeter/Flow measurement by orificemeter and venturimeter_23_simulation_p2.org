...
* Test Steps
  ...
  7. Enter the invalid inputs in the pressure drop field and click on check button and click on next button
  8. Enter the invalid inputs in the co-efficient field using the scroll bar and click on the submit button
