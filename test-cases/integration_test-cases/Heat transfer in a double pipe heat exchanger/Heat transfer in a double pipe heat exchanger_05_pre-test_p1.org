...
* Expected result
  ...
  4. If the selected option is correct a message should be displayed that the selected answer is correct and it should be validated with the backend database
