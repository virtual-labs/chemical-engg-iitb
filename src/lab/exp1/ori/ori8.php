...
$Bo=0.4904;
$pi=3.1416;
$dummy=0.6*(1.0+0.01*(mt_rand(-50,50))/100);
//$dummy=0.6;
//$dummy = round($dummy,1)." cm";
//echo "dummy ".$dummy;
//$dummy=0.6;
$del_P=($v*$v)*((1-pow($Bo,4))*$rho)/(($dummy*$dummy)*2);
//$del_P = round($del_P,1)." cm";
//echo "<br>del_P ".$del_P;
$del_h=100*$del_P/($rhom-$rho)/$g;
//$del_h = round($del_h,1)." cm";
//echo "<br>del_h ".$del_h;
$dummy1=$del_h*(1.0+0.1*(mt_rand(-50,50))/100);
//$dummy1=$del_h*((mt_rand(0.999,1.001)));
//$dummy1=$del_h;
//$dummy1 = round($dummy,1)." cm";
//echo "<br>dummy1 ".$dummy1;
//$dummy1=$del_h;
$_SESSION['dummyo'] = $dummy;
$pdrop = $del_P;
