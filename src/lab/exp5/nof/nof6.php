...
include_once("config.inc.php");
	...
	echo "<INPUT style=\"position:relative;bottom:200px;width:120px;height:30px;background-color:#D0F18F;color:#53760D;font:20px cursive;border:solid 1px #6DB72C;background-color:#D0F18F;\" TYPE=text VALUE=\"$h1c \" NAME=h1>";
	echo "<img src=img/mano.jpg>";
	echo "<INPUT style=\"position:relative;bottom:120px;width:120px;height:30px;background-color:#D0F18F;color:#53760D;font:20px cursive;border:solid 1px #6DB72C;background-color:#D0F18F;\" TYPE=text VALUE=\"$h2c \" NAME=h2><br><br>";
?>
</center>
...
No dimensions <img style="display:none;"  id="ndr" src="img/rg.png"><img id="ndw" style="display:none;" src="img/wg.png"><BR>
...
<h3>Friction factor <INPUT style="width:90px;height:30px;background-color:#D0F18F;color:#53760D;font:20px/30px cursive;border:solid 1px #6DB72C;background-color:#D0F18F;" TYPE="text" VALUE="" NAME="fric"> <INPUT TYPE="button" VALUE="Check" NAME="fric_check" onClick="check_fric();"><img style="display:none;" id="fric_r" src="img/rg.png"><img id="fric_w" style="display:none;" src="img/wg.png"></h3>
