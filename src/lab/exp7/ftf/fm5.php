...
tpre =document.volu.tpre.value;
epre = document.volu.epre.value;


res_per= ((tpre - epre)/tpre)*100;
res_per= Math.abs(res_per);
document.volu.per.value = roundNumber(res_per,2)
...
<h3>Percentage error :	<INPUT style="width:90px;height:50px;background-color:#D0F18F;color:#53760D;font:24px/30px cursive;border:solid 1px #6DB72C;background-color:#D0F18F;" TYPE="text" VALUE="" NAME="per"> </h3>
