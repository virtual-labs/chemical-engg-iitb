(function($) {
	jQuery.fn.stopwatch = function() {
		...
		function do_time() {
			...
			document.volu.vol.value  = Math.round(document.time.percent.value*0.1666*5*document.time.timer.value);
			document.time.v.value = document.volu.vol.value;
			//document.time.vol.value = document.volu.vol.value/document.time.timer.value;
