...
<body>
	<div id="container">
		<div id="top">
			<a href=index.html><img src=images/vlabs.jpg></a><br>
		</div>
		<div id="content">
			<?php
				$eid = $_SESSION['eid'];
				echo "<a href=reportri.php?eid=$eid><img border=0 src=images/download.jpg></a>";
			?>
			<a href=vle7.php><img border=0 src=images/next.jpg></a>
			<p></p>
		</div>
