...
<h1>Calibration curve for refractive index</h1><br>
...
<tr>
<td align="right">
Enter volume of 2nd component V2(ml)</td><td align="left"> <input type="text" style="width:80px;height:30px;background-color:#D0F18F;color:#53760D;font:24px/30px cursive;border:solid 1px #6DB72C;background-color:#D0F18F;" name="v2" maxlength="5" /></td></tr></table><br><br>
