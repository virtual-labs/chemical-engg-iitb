...
$SQLCommand="select eid, percent, hft, cft, thout, tcout from htl_turb where eid='$eid'";
...
<th>HFT</th>
    ...
    while($row = mysql_fetch_array($result))
        {
  echo "<tr>";
  echo "<td style='text-align: center;'>" . $row['eid'] . "</td>";
...
<center><a href=../list.php?mode=home><img border=0 src=home.jpg></a>&nbsp;&nbsp;&nbsp;<br><br><a href="report2.php?mode=<? echo $eid ?>"> <img border=0 src=download.jpg></a>&nbsp;&nbsp;&nbsp;<a href=><img border=0 src=end.jpg></a></center>
</form>
<p>
